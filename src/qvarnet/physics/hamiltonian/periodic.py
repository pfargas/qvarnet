...
subclasses :class:`~qvarnet.physics.boundaries.BoundaryHamiltonian`, so periodicity is controlled by the
...
from qvarnet.physics.boundaries import BoundaryHamiltonian
