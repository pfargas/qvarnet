...
class ExperimentConfig(BaseConfig):
    ...
    def _validate_config(self):
        required_keys = ["experiment", "model", "training", "optimizer", "sampler", "hamiltonian", "output"]
        ...
        print(f"Configuration validation passed for: {self.data.get('experiment', {}).get('name', 'unnamed')}")
